...
return [
    ...
    |
    */
    'db.table' => _env('AUTH_DB_TABLE', 'resellers'),
    ...
    */
    ...
    |
    */
    'timestamps' => _env('AUTH_TIMESTAMPS', false),
    ...
    */
    'password.encode' => function ($password) {
        return Password::hash($password, Password::BCRYPT, ['cost' => 12]);
    },
    ...
    */
    ...
    'messages.loginParamsError' => 'Password is incorrect or account does not exist!',
    ...
    */
    ...
    'messages.loginPasswordError' => 'Password is incorrect or account does not exist!',
